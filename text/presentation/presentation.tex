...
% ============ Slide 2: LeNet-5 Architecture Diagram ============
\begin{frame}
  \frametitle{Architektura LeNet-5}
  \begin{center}
    \includegraphics[width=0.9\textwidth]{LeNet-5_architecture.png}
  \end{center}
\end{frame}

% ============ Slide 3: LeNet-5 - Historia i Architektura ============
\begin{frame}[fragile]
  ...
  \begin{enumerate}
    ...
    \item \textbf{Współdzielenie wag} - mniej pamięci
